...
export class WebLocksBase {
   ...
   */
  async isSomewhereReserved(): Promise<boolean> {
  ...
  _acquireWebLock(lockName: string, options: LockOptions): Promise<Lock | null> {
