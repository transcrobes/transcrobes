...
import { WebpubManifest } from "./web-reader/WebpubManifestTypes/WebpubManifest";
import { ReadiumLink } from "./web-reader/WebpubManifestTypes/ReadiumLink";
import {
  CACHE_EXPIRATION_SECONDS,
  IS_DEV,
  PRECACHE_PUBLICATIONS,
  WEBPUB_CACHE_NAME,
} from "./web-reader/constants";
import { registerRoute } from "workbox-routing";
import { PublicationConfig, WebReaderSWConfig } from "./web-reader/types";
...
export default function initWebReaderSW({
  ...
  //     console.log("here it is so it should be managed by index.html");
  //     return true;
  //   },
