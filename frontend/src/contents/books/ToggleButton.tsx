// FIXME: copy/pasted and slightly modified from @nypl/web-reader as it is not exported
import React from "react";
import { Box as ChakraBox, ThemeProvider, useRadio, useTheme, Icon } from "@chakra-ui/react";

import Button from "./Button";
import { getTheme } from "@nypl/web-reader";
...
function ToggleButton(props: React.PropsWithoutRef<ToggleButtonProps>): React.ReactElement {
