...
##############################
# This is an async version that is supposed to be equivalent to sworker.py
# It is kept here as a reference for future development, and possibly replacement
# of confluent, as confluent has HORRIBLE update cycles (no bin wheels for 3.10 after 8 months, etc.)
##############################
...
if __name__ == "__main__":
    print("she is yo wonderful motha")
    asyncio.run(main())
